...
{
    // I love you MrCrayFish your renderer is really handy uwu
    ...
    {
        renderModel(model, transformType, stack, null);
    }

    public static void renderModel(IBakedModel model, ItemCameraTransforms.TransformType transformType, ItemStack stack, @Nullable Transform... transforms)
    {
        GlStateManager.pushMatrix();
        {
            ...
            GlStateManager.pushMatrix();
            {
                RenderUtil.renderModel(model, stack, transforms);
            }
    ...
    private static void renderModel(IBakedModel model, ItemStack stack, @Nullable Transform... transforms)
    {
    ...
    {
        IBakedModel model = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getItemModel(stack);
        applyTransformType(model, transformType);
    }

    public static void applyTransformType(IBakedModel model, ItemCameraTransforms.TransformType transformType) {
